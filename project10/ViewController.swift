...
//  project10
//
//  Created by Sultan Ali on 20/06/2020.
...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Person", for: indexPath) as? PersconCell else {
            fatalError("Cant dequeu collection view cell")
        }
        ...
        cell.labelView.text = people[indexPath.item].name
        return cell
    }
